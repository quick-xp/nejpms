...
describe "inventory_clearances/edit" do
  before(:each) do
  ...
  it "renders the edit inventory_clearance form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", inventory_clearance_path(@inventory_clearance), "post" do
